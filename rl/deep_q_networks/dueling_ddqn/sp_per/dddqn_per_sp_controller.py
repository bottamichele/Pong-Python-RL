...
class DuelingDDQN_PER_SPController(BaseDQNSPBotController):
    """A bot that uses Dueling Deep Q-Networks (Dueling DDQN) to play on Pong (trained with self-play technique and prioritized memory replay)."""
