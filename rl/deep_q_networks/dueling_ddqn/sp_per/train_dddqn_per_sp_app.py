...
from .train_dddqn_per_sp_bot_controller import DuelingDDQNTrainining_PER_SPBotController

class DDDQNTraining_PER_SPApp(BaseTrainDQNSPApp):
    ...
    def _create_controller_1(self):
        self._controller_1 = DuelingDDQNTrainining_PER_SPBotController(self._current_game, self._training_session)
