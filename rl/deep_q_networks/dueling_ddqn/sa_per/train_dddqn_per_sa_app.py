...
from .train_dddqn_per_sa_bot_controller import DDDQNTrainining_PER_SABotController

class DDDQNTraining_PER_SAApp(TrainingSAApp):
    ...
    def __init__(self, training_session):
        ...
        self._beta_decay = (1.0 - self._training_session.memory.beta) / self._training_session.n_episodes

    def _create_controller_1(self):
        self._controller_1 = DDDQNTrainining_PER_SABotController(self._current_game, self._training_session)
    ...
    def _on_post_episode(self):
        ...
        self._training_session.memory.beta += self._beta_decay