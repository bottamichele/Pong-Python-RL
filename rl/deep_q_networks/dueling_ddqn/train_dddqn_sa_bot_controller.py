...
class DDDQNTraininingSABotController(TrainingBotController):
    """A bot controller that uses Dueling Double Deep Q-Networks (Dueling DDQN) to be trained playing against a basic or high skill bot on Pong."""
