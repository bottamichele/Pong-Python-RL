...
from .costants import TRAINING_PATH, TRAINING_SESSION_PATH, MODEL_PATH, MODEL_NAME
from .dueling_ddqn import DuelingDDQN

class DDDQNTrainingSASession(TrainingSASession):
    """A session for traning of a single agent thats uses Dueling DDQN."""
    ...
    def __init__(self, n_episodes, mem_size, batch_size, update_rate_target, lr=10**-4, gamma=0.99, eps_init=1.0, eps_min=0.01, eps_decay=9.9*10**-6):
        ...
        self.history_q = deque(maxlen=35000)
