...
TRAINING_PATH = "./rl/deep_q_networks/dueling_ddqn/models/"
MODEL_PATH = "./rl/models/v.s. Bot/"
TRAINING_SESSION_PATH = TRAINING_PATH + "training_session/"
MODEL_NAME = "pong_dueling_ddqn.pth"

# ==================================================
# =========== DUELING DDQN BOT CONTROLLER ==========
# ==================================================

class DuelingDDQNBotController(Controller):
    """A bot controller that uses Dueling Double Deep Q-Networks (Dueling DDQN) to control a paddle."""

    def __init__(self, a_paddle, position, current_game):
        """Create Dueling DDQN controller.
        ...
        self._model = DuelingDDQN(FULL_OBSERVATION_SIZE)                       #Neural network used for playing.
...
# ==================================================
# ========== DUELING DDQN TRAINING SESSION =========
# ==================================================

class DuelingDDQNTrainingSession(TrainingSession):
    """Training session for training a Dueling DDQN bot."""
    ...
    def __init__(self, n_episodes, mem_size, batch_size, update_rate_target, lr=10**-4, gamma=0.99, eps_init=1.0, eps_min=0.01, eps_decay=10**-5):
        """Create new Dueling DDQN training session.
...
# ==================================================
# ====== DUELING DDQN TRAINING BOT CONTROLLER ======
# ==================================================

class DuelingDDQNTraininingBotController(TrainingBotController):
    """A bot controller that uses Dueling Double Deep Q-Networks (Dueling DDQN) to be trainined playing Pong."""

    def __init__(self, a_paddle, position, current_game, training_session):
        """Create new Dueling DDQN bot controller to be tranined.
        ...
        training_session: DuelingDDQNTrainingSession
            training session"""
