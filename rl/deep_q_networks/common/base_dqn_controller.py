...
from rl.common.utils import get_full_observation_normalized, FULL_OBSERVATION_SIZE
...
class BaseDQNSABotController(Controller):
    ...
    def __init__(self, current_game, get_obs_fun=get_full_observation_normalized, obs_size=FULL_OBSERVATION_SIZE):
        ...
        super().__init__(current_game.paddle_1, PaddlePosition.LEFT)
