...
class DDQNTraininingSABotController(TrainingBotController):
    """A bot controller that uses Double Deep Q-Networks (DDQN) to be trained playing against a basic or high skill bot on Pong."""
