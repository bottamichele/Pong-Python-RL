...
from .ddqn_controller import DDQNTraininingBotController

class DDQNTrainingBotApp(TrainingBotApp):
    ...
    def _create_bot_controller(self, current_game):
        return DDQNTraininingBotController(current_game.paddle_1 if self._paddle_position_to_control == PaddlePosition.LEFT else current_game.paddle_2,
